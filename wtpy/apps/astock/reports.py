            ...
            trips.append(
                {
                    ...
                    "卖出价_普通前复权参考": getattr(f, "standard_qfq_reference_price", None),
                    "卖出复权因子": sell_fac,
                    "卖出复权比例": sell_scale,
            ...
            trips.append(
                {
                    ...
                    "买入价_普通前复权参考": getattr(b, "standard_qfq_reference_price", None),
                    "买入复权因子": buy_fac,
                    "买入复权比例": buy_scale,
                    "卖出日期": sell_date,
                    "卖出价": sell_price,
...
def write_backtest_csv(
    ...
    *,
            ...
            w.writerow(
                {
                    ...
                    "execution_price": getattr(x, "execution_price", None) or x.price,
                    "adjusted_reference_price": getattr(x, "adjusted_reference_price", None),
                    "point_in_time_reference_price": getattr(x, "point_in_time_reference_price", None),
                    "standard_qfq_reference_price": getattr(x, "standard_qfq_reference_price", None),
                    "adjustment_factor": getattr(x, "adjustment_factor", None),
                    "adjustment_scale": getattr(x, "adjustment_scale", None),
                    "qfq_scale": getattr(x, "qfq_scale", None),
                    "point_scale": getattr(x, "point_scale", None),
    ...
    trade_fields = TRADE_TRIP_FIELDS
